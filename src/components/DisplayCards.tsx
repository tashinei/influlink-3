        ...
        <div className="lg:pl-10">
          ...
          <p className="mt-4 text-lg text-[#2b2b2b] max-w-lg">
            {isCreator
              ...
              : "Откривайте подходящи инфлуенсъри, създавайте кампании и управлявайте плащанията в един ясен и прозрачен процес."}
          </p>
        </div>
