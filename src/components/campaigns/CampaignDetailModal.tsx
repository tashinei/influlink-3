...
import { CampaignData, CAMPAIGN_STATUS_LABELS, CAMPAIGN_TYPE_LABELS } from "@/types/campaigns";
    ...
    return (
        <>
            <Dialog open={open} onOpenChange={onOpenChange}>
                <DialogContent className="max-h-[95vh] w-[95vw] max-w-4xl overflow-hidden p-8">
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-sm font-medium">
                                                        {campaign.startDate ? format(new Date(campaign.startDate), "MMM d, yyyy") : "N/A"}
                                                    </p>
                                                </div>
                                            </div>
                                            <div className="flex items-center gap-3">
