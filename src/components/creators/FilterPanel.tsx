...
const languagesList = ["English", "Spanish", "French", "German", "Portuguese", "Italian", "Japanese", "Bulgarian", "Hindi", "Chinese", "Native"];
            ...
            <aside className={`fixed lg:sticky top-0 right-0 h-full lg:h-[calc(100vh-4rem)] lg:top-8 z-[5000] lg:z-[51] w-[85%] sm:w-80 lg:w-72 bg-white dark:bg-zinc-950 lg:bg-transparent border-l dark:border-zinc-800 lg:border-none lg:glass-card rounded-none lg:rounded-2xl p-6 flex flex-col transform transition-transform duration-300 ease-out ${isOpen ? "translate-x-0" : "translate-x-full lg:translate-x-0"} shadow-2xl lg:shadow-none`}>
                ...
                <div className={`flex-1 overflow-y-auto pr-2 -mr-2 space-y-7 transition-all duration-500 ${collapsed ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
                    ...
                    <div className="space-y-3">
                        <Label className="text-[11px] font-bold text-zinc-400 uppercase tracking-widest">Niches</Label>
                        ...
                        <div className="flex flex-wrap gap-1.5">
                            {platforms.map((p) => (
                                <Badge
                                    ...
                                    className="cursor-pointer rounded-md px-2 py-1 text-[11px]"
                    ...
                    <div className="space-y-3">
                        ...
                        <div
                            ...
                            className="flex items-center justify-between border dark:border-zinc-800 rounded-lg px-3 py-2 bg-background/50 hover:bg-zinc-100 dark:hover:bg-zinc-900 transition-all cursor-pointer min-h-[36px]"
                        >
                            ...
                            {languagesList.map((lang) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`
                        px-2 py-1 rounded-md text-[11px] font-medium border transition-all duration-200
                        ${isSel
