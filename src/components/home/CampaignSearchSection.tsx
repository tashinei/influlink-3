      ...
      <div className="container mx-auto max-w-6xl sm:max-w-ful pl-[1rem] pr-[1rem]">
        ...
        <div className="text-center mb-8 md:mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto text-sm md:text-base">
            Browse active brand campaigns and apply to the ones that fit you best
          </p>
        </div>
          ...
          <CardContent className="p-4 md:p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
              ...
              <div className="space-y-2">
                <Label className="text-sm font-semibold text-primary">Niche</Label>
              ...
              {/* BUDGET */}
              <div className="space-y-2">
                <Label className="text-sm font-semibold text-primary">Max Budget</Label>
            ...
            {showAllFilters && (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6 border-t animate-in fade-in slide-in-from-top-4 duration-300">
                <div className="space-y-2">
                  <Label className="text-sm font-semibold text-primary">Content Type</Label>
                  <div className="flex flex-wrap gap-2 p-3 bg-muted/30 rounded-xl">
                ...
                <div className="flex items-center justify-between md:justify-start gap-4 p-4 bg-primary/5 rounded-xl border border-primary/10 self-end">
                  <div className="space-y-0.5">
                    <Label className="text-sm font-bold">Urgent Only</Label>
                    <p className="text-[10px] text-muted-foreground">High priority campaigns</p>
                  </div>
            ...
            <div className="flex flex-col md:flex-row gap-3 pt-8 mt-4 border-t">
              <Button
                size="lg"
                className="w-full md:flex-1 h-14 rounded-xl text-lg font-bold shadow-lg shadow-primary/20"
