...
const BrandAbout = () => {
    ...
    return (
        ...
        >
            ...
            {/* Waitlist Section */}
            <section className="flex py-20 lg:pb-[35rem] xl:pb-[15rem] bg-white">
                <div className="container mx-auto px-4">
                    {/* SECTION HEADER */}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
                        ...
                        <div className="transition duration-300 ease-in-out hover:scale-105 col-span-1 md:col-span-2 bg-gradient-to-t from-[#90d5f3ff] via-secondary to-primary text-white p-8 lg:p-12 rounded-3xl shadow-2xl min-h-[450px] flex flex-col justify-end relative overflow-hidden h-[80%]"
                            ...
                            <h3 className="text-4xl md:text-6xl font-extrabold mb-6 leading-tight z-10 relative">
                                {t("brandAbout.card_1.title")}
                            </h3>
                            <p className="mb-10 text-lg max-w-2xl z-10 relative">
                                {t("brandAbout.card_1.description")}
                            </p>
                        </div>

                        <div className="col-span-1 md:col-span-1 grid grid-cols-1 gap-6 h-auto lg:h-[75vh] lg:flex lg:flex-col lg:space-y-6">

                            {/* Map your cards or list them here. Using a common class for all cards */}
                            {[
                                { img: cardPay, t1: "brandAbout.card_2.title", t2: "brandAbout.card_2.subtitle" },
                                // { img: support, t1: "brandAbout.card_3.subtitle", t2: "brandAbout.card_3.title" },
                                { img: handshake, t1: "brandAbout.card_4.subtitle", t2: "brandAbout.card_4.title" },
                                { img: chart, t1: "brandAbout.card_5.subtitle", t2: "brandAbout.card_5.title" }
                            ].map((card, idx) => (
                                <div
                                    key={idx}
                                    className="group relative overflow-hidden rounded-3xl border border-gray-200 bg-gradient-to-br from-[#90d5f3ff] via-secondary to-primary p-6 shadow-xl transition-all duration-300 hover:scale-[1.02] flex flex-col justify-end min-h-[200px] lg:flex-1"
                                >
                                    {/* Background image: added transform-gpu for smoother scaling */}
                                    <img
                                        src={card.img}
                                        alt="Background"
